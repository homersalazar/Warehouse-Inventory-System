...
@section('content')
    <div class="flex flex-col pt-5 px-2 sm:px-10 w-full mb-10">
        <h1 class="text-left text-lg sm:text-2xl font-bold mb-2">Current Stock List</h1>
        <div class="py-5">
            ...
            <table id="current_stock_list" style="width: 100%;" class="w-full text-sm text-left">
                <thead>
                    <tr class="text-center">
                        <th id="title" class="py-6 text-2xl underline" colspan="4">Current Stock List</th>
                    </tr>
                    <tr class="border-b">
    ...
    <script>
        ...
        const Excel = (type) => {
            var data = document.getElementById('current_stock_list');
