...
@section('content')
    <div class="flex flex-col pt-5 px-2 sm:px-10 w-full mb-10">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-5 mt-5 gap-1">
            ...
            <a href="/report/new_stock" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 max-sm:text-center"><i class="fa-solid fa-list-check text-2xl sm:text-base"></i> <span class="max-sm:hidden"> New Stock Counts</span></a>
