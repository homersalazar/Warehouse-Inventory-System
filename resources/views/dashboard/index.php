    ...
    <table id="productTable" style="width: 100%;" class="w-full text-sm text-left mt-5">
      <thead class="text-xs uppercase">
        ...
        <tr class="max-sm:hidden">
          <th class="px-6 py-4">
            <input type="text" id="nameInput" name="" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full" placeholder="Search by Name (any parts)">
          </th>
          <th class="px-6 py-4">
            <input type="text" id="skuInput" name="" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full" placeholder="Search by SKU">
          </th>
          <th class="px-6 py-4">
            <select type="text" id="areaSelect" name="" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full">
          ...
          <th class="px-6 py-4">
            <select type="text" id="manufacturerSelect" name="" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full">
        ...
        @foreach ($products as $row) 
          <tr class="border-b">
            ...
            <td class="px-6 py-4">
              ...
              @else
                {{ $user->location->loc_name }} <span class="bg-red-600 px-2.5 py-0.5 rounded-lg text-white font-bold">({{ $productTotals[$row->id] }})</span>
              @endif
            </td>
          </tr>
        @endforeach 
